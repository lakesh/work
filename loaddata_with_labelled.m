function [inputData missingValuesIndex collocatedData] = loaddata_with_labelled()

    %For year 2006%
    interpolatedMISRPath = '/work/testset/MISR/';
    interpolatedMODISPath = '/work/testset/MODIS/';
    collocatedDataPath = '/work/';
    ...
    collocatedData = load([collocatedDataPath 'collocated_MISR_MODIS_AERONET_2006.mat']);
